...
public class Book_Linked {
	
	private int count = 0;
	private List<String> categories;
	private float revenue;

	private LinkedHashMap<Integer, personNode> personDB = new LinkedHashMap<Integer, personNode>();
	private ArrayListMultimap<String, bookOrderNode> orderDB = ArrayListMultimap.create();

	public Book_Linked(String dbFileName, String ordersFileName, final List<String> categories) throws InterruptedException {
